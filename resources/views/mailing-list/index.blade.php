<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <div>
                <a href="{{ route('mailing_list.create') }}">
                    <x-secondary-button>
                        Nuova mailing list
                    </x-secondary-button>
                </a>
                ...
                <tbody class="text-sm divide-y divide-gray-200 dark:divide-gray-800">
                    ...
                    @foreach ($mailingLists as $mailList)
                        <tr class="">
                            ...
                            <td class="w-6">
                                <form method="POST" action="{{ route('mailing_list.destroy', $mailList) }}"
                                    class="pt-1"
                                    onclick="return confirm('Vuoi davvero eliminare questa mailing list?');">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
